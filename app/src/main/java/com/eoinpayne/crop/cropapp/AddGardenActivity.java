...
//
//        mGardenNameText = (EditText) findViewById(R.id.EnterGardenNameTxt);
...
//        setDefaultDateTime();
//
//        // OnClickListener for the Date bu tton, calls showDatePickerDialog() to show
//        // the Date dialog
...
//
//                //returned cancelled intent (return ok or CANCEL to the thing that called. i.e ToDomgrActivity foterView
...
//
//                //TODO -  Title XX
//                String gardenNameString = mGardenNameText.getText().toString(); //mTitleText
//
//                // Date
...
//                GardenTabItem.packageIntent(data, gardenNameString, fullDate);
//
//                //TODO - return data Intent and finish XX
